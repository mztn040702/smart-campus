...
-- 插入测试数据
-- 测试用户
INSERT INTO user (username, password, real_name, college, role) VALUES
('admin', 'admin123', '管理员', '计算机学院', 'admin'),
('student1', '123456', '张三', '计算机学院', 'student'),
('student2', '123456', '李四', '经济管理学院', 'student'),
('student3', '123456', '王五', '外国语学院', 'student');
